                                    ...
                                    <tbody>
                                        <?php foreach ($posts as $i => $post) : ?>
                                            <tr>
                                                ...
                                                <td><?= $post['kategori'] ?></td>
                                                <td>
                                                    <a href="/admin/posts/edit" class="btn btn-sm btn-warning me-1"><i class="fas fa-edit"> Edit</i></a>
                                                    <a href="/admin/posts/delete" class="btn btn-sm btn-danger me-1"><i class="fas fa-trash"> Delete</i></a>
                                                </td>
                                            </tr>
                                        <?php endforeach; ?>
                                    </tbody>
